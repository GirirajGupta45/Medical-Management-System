...
public class BillGenerator extends javax.swing.JFrame {
    ...
    public boolean checkAvail(JComboBox q,JComboBox n){
       int qty=Integer.parseInt((String)q.getSelectedItem());
       String name=(String)n.getSelectedItem();
       try{
         PreparedStatement ps1=conn.prepareStatement("select name from medicines where name=? and available<?");
    ...
    private void q1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_q1ActionPerformed
       ...
       t1.setText(price+"");
              ...
              JOptionPane.showMessageDialog(this,"please Reduce Quantity ");
              t1.setText("");
              q1.setEnabled(true);
        }
